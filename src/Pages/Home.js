    ...
    <>
      ...
      <div className="Pitch3">
        <p>
          ...
          There's a comment section that helps with engagement, if you like the
          recipe let others know, if you added something to spice up the recipe
          let us know as well. Have a recipe you love? Share it! At Mix it up,
          we encourage users to share their plates. So what are you waiting for?
          Sign up and let's see how what you can Mix up.
        </p>
      </div>
