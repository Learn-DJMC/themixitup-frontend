...
const Header = ({currentUser, signout}) => {
  ...
  return (
    ...
    <main className="Header">
        ...
        {currentUser && (
            <>
            <NavItem><NavLink to="/recipes">Recipes</NavLink></NavItem>
            <NavItem><NavLink to="/signout">Sign Out</NavLink></NavItem>
            <NavItem><NavLink to="/recipes-protected-index">My Recipes</NavLink></NavItem>
            </>
        )}
